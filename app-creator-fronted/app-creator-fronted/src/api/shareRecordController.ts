...
/** 获取分享预览 获取分享预览 GET /shareRecord/preview/${param0} */
export async function getSharePreview(
  params: API.getSharePreviewParams,
  options?: { [key: string]: any },
) {
  const { targetId: param0, ...queryParams } = params
  return request<API.ServerResponseEntitySharePreviewVO>(`/shareRecord/preview/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  })
