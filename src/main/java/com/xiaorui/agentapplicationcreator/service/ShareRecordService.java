...
public interface ShareRecordService extends IService<ShareRecord> {
    ...
    boolean doShare(ShareDoRequest shareDoRequest, String userId);

    List<ShareRecordVO> listUnreadShares(String userId, int limit);

    void markSharesAsRead(String userId, List<String> shareIds);
