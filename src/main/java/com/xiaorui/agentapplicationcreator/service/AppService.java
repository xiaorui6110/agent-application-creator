...
public interface AppService extends IService<App> {
    ...
    AppVO getPrivateAppInfo(String appId);

    List<AppVO> getAppInfoList(List<App> appList);

    List<AppVO> getPrivateAppInfoList(List<App> appList);
    ...
    /**
     * Validate that the current user can access the app.
     *
     * @param appId app id
     * @return app entity
     */
    App validateAppAccess(String appId);
}
